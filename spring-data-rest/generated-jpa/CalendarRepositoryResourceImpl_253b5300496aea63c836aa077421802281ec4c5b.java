...
// $VF: synthetic class
@ApplicationScoped
public class CalendarRepositoryResourceImpl_253b5300496aea63c836aa077421802281ec4c5b implements RestDataResource {
   public List list(Page var1, Sort var2, String var3, Map var4) {
      ...
      Class var7 = Class.forName("acme.CalendarRepository", false, var5);
      Annotation[] var8 = new Annotation[0];
      Object var9 = var6.instance(var7, var8).get();
      if (var9 != null) {
         return (List)((CrudRepository)var9).findAll();
      } else {
         throw (Throwable)(new RuntimeException("acme.CalendarRepository instance was not found"));
      }
   }
   ...
   public Object get(Object var1) {
      ...
      Class var4 = Class.forName("acme.CalendarRepository", false, var2);
   ...
   public Object update(Object var1, Object var2) {
      ((Calendar)var2).$$_hibernate_write_id((Long)var1);
      ArcContainer var4 = Arc.container();
      ClassLoader var3 = Thread.currentThread().getContextClassLoader();
      Class var5 = Class.forName("acme.CalendarRepository", false, var3);
